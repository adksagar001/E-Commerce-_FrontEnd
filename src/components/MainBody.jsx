...
import {
  ...
  ApiCallWithLocalStorageWithoutData
} from "../services/api";
...
function Mainbody() {
 function showLoading() {
  ...
  // 3️⃣ Fetch products depending on login
  useEffect(() => {
    
    if (isLoggedIn === null || hasFetched.current) return; 
    hasFetched.current = true;
    if (isLoggedIn) {
      ApiCallWithLocalStorageWithoutData("products/getAllProducts",setProducts,setLoading);
    } else {
      ApiCallWithoutDataNoAsync("products/getAllProducts/public?orgId=1",setProducts,setLoading);
    }
  }, [isLoggedIn]);
            ...
            <div className="d-flex justify-content-between">
              {loading||catLoading?(showLoading()||null):
                ...
                <a className="icon-nav-item" href="#!" key={CategoryName.id}>
                  <div
                    className="icon-container mb-2 bg-primary-subtle"
                    data-bs-theme="light"
                  >
                    <span
                      className="fs-4 text-warning"
                      data-feather={CategoryName.icon}
                    ></span>
                  </div>
            ...
            <div className="row flex-center mb-15 mt-11 gy-6">
              ...
              <div className="col-auto">
                <div className="text-center text-lg-start">
                  ...
                  <a className="btn btn-lg btn-primary px-7" href="/register">
                    Sign up
