                ...
                <table className="table fs-9 mb-0 border-top border-translucent">
                  ...
                  <tbody className="list" id="table-latest-review-body">
                    <tr className="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      >
                        <p className="fs-9 fw-semibold text-body-highlight mb-0">
                          ...
                          shape and needed some motivation, so I decided to
                          treat myself to a new Fitbit.
                        </p>
                      </td>
                    ...
                    <tr className="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      >
                        <p className="fs-9 fw-semibold text-body-highlight mb-0">
                          ...
                          wouldn't choose it if I were searching for a computer
                          that I would use frequently. It's...
                          <a href="#!">See more</a>
                        </p>
                      </td>
                      <td className="align-middle text-start ps-5 status">
                    ...
                    <tr className="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      >
                        <p className="fs-9 fw-semibold text-body-highlight mb-0">
                          I have started using this theme in the last week and
                          it has really impressed me very much, the support is
                          second to none.
                        </p>
                      </td>
                      <td className="align-middle text-start ps-5 status">
                    ...
                    <tr className="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      >
                        <p className="fs-9 fw-semibold text-body-highlight mb-0">
                          ...
                          products is unsurpassed. Great theme ...
                          <a href="#!">See more</a>
                        </p>
                      </td>
                      <td className="align-middle text-start ps-5 status">
                    ...
                    <tr className="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      >
                        <p className="fs-9 fw-semibold text-body-highlight mb-0">
                          This template has allowed me to convert my existing
                          web app into a great looking, easy to use UI in less
                          than 2 weeks. Very easy to us...
                          <a href="#!">See more</a>
                        </p>
                      </td>
                      <td className="align-middle text-start ps-5 status">
                    ...
                    <tr className="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      >
                        <p className="fs-9 fw-semibold text-body-highlight mb-0">
                          As others mentioned, the team behind this theme is
                          super responsive. I sent a message during the weekend,
                          fully expecting a response a...
                          <a href="#!">See more</a>
                        </p>
                      </td>
                      <td className="align-middle text-start ps-5 status">
                    ...
                    <tr className="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      >
                        <p className="fs-9 fw-semibold text-body-highlight mb-0">
                          ...
                          contacted the team they were able to help me set up
                          the theme. It's really good and I ...
                          <a href="#!">See more</a>
                        </p>
                      </td>
                      <td className="align-middle text-start ps-5 status">
