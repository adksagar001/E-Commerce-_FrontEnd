            ...
            <table className="table fs-9 mb-0 border-top border-translucent">
              ...
              <tbody className="list" id="table-latest-review-body">
                ...
                <tr className="hover-actions-trigger btn-reveal-trigger position-static">
                  ...
                  <td className="align-middle review" style="min-width:350px;">
                    <p className="fs-9 fw-semibold text-body-highlight mb-0">
                      ...
                      going back. My first Mac lasted over nine years, and this
                      is my second.
                    </p>
                  </td>
                  <td className="align-middle text-start ps-5 status">
                ...
                <tr className="hover-actions-trigger btn-reveal-trigger position-static">
                  ...
                  <td className="align-middle review" style="min-width:350px;">
                    <p className="fs-9 fw-semibold text-body-highlight mb-0">
                      ...
                      use frequently. It's...<a href="#!">See more</a>
                    </p>
                  </td>
                  <td className="align-middle text-start ps-5 status">
                    <span className="badge badge-phoenix fs-10 badge-phoenix-warning">
                ...
                <tr className="hover-actions-trigger btn-reveal-trigger position-static">
                  ...
                  <td className="align-middle review" style="min-width:350px;">
                    <p className="fs-9 fw-semibold text-body-highlight mb-0">
                      It performs exactly as expected. There are three of these
                      in the family.
                    </p>
                  </td>
                  <td className="align-middle text-start ps-5 status">
                ...
                <tr className="hover-actions-trigger btn-reveal-trigger position-static">
                  ...
                  <td className="align-middle review" style="min-width:350px;">
                    <p className="fs-9 fw-semibold text-body-highlight mb-0">
                      ...
                      unsurpassed. Great theme ...<a href="#!">See more</a>
                    </p>
                  </td>
                  <td className="align-middle text-start ps-5 status">
                    <span className="badge badge-phoenix fs-10 badge-phoenix-success">
                ...
                <tr className="hover-actions-trigger btn-reveal-trigger position-static">
                  ...
                  <td className="align-middle review" style="min-width:350px;">
                    <p className="fs-9 fw-semibold text-body-highlight mb-0">
                      ...
                      weeks. Very easy to us...<a href="#!">See more</a>
                    </p>
                  </td>
                  <td className="align-middle text-start ps-5 status">
                    <span className="badge badge-phoenix fs-10 badge-phoenix-success">
                ...
                <tr className="hover-actions-trigger btn-reveal-trigger position-static">
                  ...
                  <td className="align-middle review" style="min-width:350px;">
                    <p className="fs-9 fw-semibold text-body-highlight mb-0">
                      I had a bit of a hard time at first but after I contacted
                      the team they were able to help me set up the theme. It's
                      really good and I ...<a href="#!">See more</a>
                    </p>
                  </td>
                  <td className="align-middle text-start ps-5 status">
                    <span className="badge badge-phoenix fs-10 badge-phoenix-warning">
                ...
                <tr className="hover-actions-trigger btn-reveal-trigger position-static">
                  ...
                  <td className="align-middle review" style="min-width:350px;">
                    <p className="fs-9 fw-semibold text-body-highlight mb-0">
                      This theme is great. Clean and easy to understand. Perfect
                      for those who don't have time to start everything from
                      scratch. The support...<a href="#!">See more</a>
                    </p>
                  </td>
                  <td className="align-middle text-start ps-5 status">
                    <span className="badge badge-phoenix fs-10 badge-phoenix-success">
